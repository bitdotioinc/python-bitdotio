...
[**create_query**](ApiBitdotio.md#create_query) | **POST** /query/ | 
...
# **create_import_json**
> IngestionResult create_import_json()
...
# **create_import_url**
> IngestionResult create_import_url()
...
with bitdotio.ApiClient(configuration) as api_client:
    ...
    # and optional values
    try:
        api_response = api_instance.create_query(query=query)
        pprint(api_response)
    except bitdotio.ApiException as e:
        print("Exception when calling ApiBitdotio->create_query: %s\n" % e)
```
