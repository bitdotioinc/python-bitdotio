...
from bitdotio import rest
from bitdotio.configuration import Configuration
from bitdotio.exceptions import ApiTypeError, ApiValueError, ApiException
from bitdotio.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ApiBitdotio()
        api_instance.create_import_file  # this is an instance of the class Endpoint
        api_instance.create_import_file()  # this invokes api_instance.create_import_file.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_import_file.callable or self.callable in this class
